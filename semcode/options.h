...
Class used for game option / setting
to set some parameters in game
...
class Menu_Options{
    private:
      ...
      uint16_t selected_colors[7] = {BRIGHT_BLUE, BRIGHT_GREEN, DARK_BLUE, DARK_GREEN, PURPLE, YELLOW, ORANGE};
    ...
    public:
      ...
      */
      ...
      /*
        ...
        Function cotnrols marked button in option system
      ...
      */
      int options_selection(char key_pressed, int& pointer, int& speed, int& size_of_tile, uint16_t& snake_1_color, uint16_t& snake_2_color);
      ...
      */
      void options_fill_array(uint16_t* fb, unsigned char *parlcd_mem_base, Game_Properties gp);
};
#endif